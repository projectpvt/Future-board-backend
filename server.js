...
// TEMPORARY. Lets you confirm from a browser that the API key works.
// Visit: https://your-service.onrender.com/test
// DELETE THIS ROUTE once you have seen it succeed.
app.get('/test', async (req, res) => {
  try {
    const text = await callClaude('Reply with exactly: the key works', 20);
    res.send(`SUCCESS. Claude replied: ${text}`);
  } catch (err) {
